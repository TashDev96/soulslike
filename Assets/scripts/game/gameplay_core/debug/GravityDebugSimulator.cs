...
namespace game.gameplay_core.debug
{
	public class GravityDebugSimulator : MonoBehaviour
	{
		...
		private Vector3 StartVelocity
		{
			get
			{
				return transform.forward * _startSpeed;
			}
		}
		...
		private void SaveGravityToProjectSettings()
		{
			...
			SerializedObject serializedObject = new SerializedObject(physicsManager);
			SerializedProperty gravityProperty = serializedObject.FindProperty("m_Gravity");
