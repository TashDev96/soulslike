...
namespace game.gameplay_core.characters.ai.utility.editor
{
    public class UtilityWeightHistoryWindow : EditorWindow
    {
        ...
        private Dictionary<string, List<float>> _weightHistory = new();
        private Dictionary<string, Color> _actionColors = new();
        ...
        {
            if (_target == null || sender != _target) return;
        ...
        private void DrawTargetSelection()
        {
            ...
            if (_target == null || GUILayout.Button("Get from Selection", GUILayout.Width(120)))
            {
                if (Selection.activeGameObject != null)
                {
                    ...
                    {
                        EditorUtility.DisplayDialog("No SubUtilityBase", "Selected GameObject doesn't have a SubUtilityBase component.", "OK");
                    }
                }
                else
                {
